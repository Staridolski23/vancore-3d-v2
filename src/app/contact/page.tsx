            ...
            <div>
              ...
              <div className="space-y-4 text-sm text-[#111]">
                ...
                <div>
                  ...
                  <a href="/ai-analyst" className="inline-flex items-center gap-2 hover:text-[#c94f2b]">
            ...
            <div className="border border-[#e5e5e5] rounded-sm p-6 md:p-8">
              {sent ? (
                <div className="text-center py-12">
                  <div className="text-[#c94f2b] font-display text-2xl mb-3">Message sent.</div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input id="name" type="text" required placeholder="Your name" className="w-full bg-white border border-[#e5e5e5] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#c94f2b]/40" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-xs text-[#6b6b6b] mb-1">Email</label>
                    <input id="email" type="email" required placeholder="you@company.com" className="w-full bg-white border border-[#e5e5e5] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#c94f2b]/40" />
                  </div>
                  <div>
                    <label htmlFor="company" className="block text-xs text-[#6b6b6b] mb-1">Company</label>
                    <input id="company" type="text" placeholder="Company name" className="w-full bg-white border border-[#e5e5e5] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#c94f2b]/40" />
                  </div>
                  <div>
                    <label htmlFor="message" className="block text-xs text-[#6b6b6b] mb-1">What's the problem?</label>
                    <textarea id="message" required rows={4} placeholder="Describe the situation you're facing..." className="w-full bg-white border border-[#e5e5e5] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#c94f2b]/40 resize-none" />
                  </div>
                  <button type="submit" className="w-full py-2.5 rounded-lg bg-[#c94f2b] text-white text-sm font-medium hover:bg-[#a83d1f] transition-colors">
                    Send message
                  </button>
                </form>
              )}
